...
if (isset($_GET['id'])) {
    ...
    $resultado = $objeto->apagarCargaHoraria($id);
}
?>
<!DOCTYPE html>
<html lang="pt-br">
                ...
                <table class="table table-hover table-bordered mt-5" style="background:white">
                    <thead class="thead-dark">
                        <tr>
                            ...
                            <th scope="col" style="vertical-align:middle">Entrada</th>
                            <th scope="col" style="vertical-align:middle">Saída</th>
                            <th scope="col" style="vertical-align:middle">Entrada</th>
                            <th scope="col" style="vertical-align:middle">Saída</th>
                            <th scope="col" style="vertical-align:middle">Jornada</th>
                            <th scope="col" style="vertical-align:middle">Tipo de trabalho</th>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    $tipo_trabalho = new TipoTrabalho();
                                    if ($registro->id_tipo_trabalho) {
                                        $resultado = $tipo_trabalho->selecionarTipoTrabalhoWhere($registro->id_tipo_trabalho);
                                ...
                                if (!($acesso == "disabled")) {
                                ?>
                                    <td class="text-center"><a href='editar_carga_horaria.php?id=<?= $registro->id ?>'><i class='fas fa-edit'></i></a></td>
                                    <td class="text-center"><a href='exibir_carga_horaria.php?id=<?= $registro->id ?>'><i class='fa fa-trash' aria-hidden='true'></i></a></i></td>
                                <?php
                                }
                                ?>
                            </tr>
