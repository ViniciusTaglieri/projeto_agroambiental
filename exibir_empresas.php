...
if (isset($_GET['cnpj'])) {
    $cnpj = $_GET['cnpj'];
    $objeto = new empresa();
    $resultado = $objeto->apagarEmpresa($cnpj);
}
?>
<!DOCTYPE html>
<html lang="pt-br">
                ...
                <table class="table table-hover table-bordered mt-5" style="background:white">
                    <thead class="thead-dark">
                        <tr>
                            ...
                            <th scope="col" style="vertical-align:middle">Inscrição Estadual</th>
                            <th scope="col" style="vertical-align:middle">Endereço</th>
                            <th scope="col" style="vertical-align:middle">Número</th>
                            ...
                            <th scope="col" class="text-center" style="vertical-align:middle">Mais detalhes</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    if ($registro->id_cidade) {
                                        $resultado = $cidade->selecionaCidadeWhere($registro->id_cidade);
                                ...
                                <td>
                                    <button onclick="vejamais(<?= $registro->cnpj ?>)" class="btn btn-primary">Veja mais</button>
                                    <div id="overlay">
                                        <div id="text">
                                            <p id="vermais"></p>
                                        </div>
                                ...
                                if (!($acesso == "disabled")) {
                                ?>
                                    <td class="text-center"><a href='editar_empresa.php?cnpj=<?= $registro->cnpj ?>'><i class='fas fa-edit'></i></a></td>
                                    <td class="text-center"><a href='exibir_empresas.php?cnpj=<?= $registro->cnpj ?>'><i class='fa fa-trash' aria-hidden='true'></i></a></td>
                                <?php
                                }
                                ?>
                            </tr>
