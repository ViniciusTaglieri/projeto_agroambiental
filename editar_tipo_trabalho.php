<?php
    ...
    $resultado = $objeto->selecionarTipoTrabalhoWhere($id);
    ...
    <div class="row">
        ...
        <div class="col-lg-10">
            <div class="row">
                ...
                <div class="col-lg-8">
                    <form action="update_tipo_trabalho.php" method="POST" class="formulario">
                    <h2 class="text-center py-4">Alterar Tipo Trabalho</h2>
                        <div class="form-group">
                            <input type="text" class="form-control" name="tipo" placeholder="Digite o tipo do trabalho" maxlength="30" value="<?=$registro->tipo?>" pattern="{0,30}" required >
