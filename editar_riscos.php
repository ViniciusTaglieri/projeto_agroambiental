<?php
    ...
    $id = $_GET['id'];
    $objeto = new Riscos();
    $resultado = $objeto->selecionarRiscosWhere($id);
    ...
    <div class="row">
        ...
        <div class="col-lg-10">
            <div class="row">
                ...
                <div class="col-lg-8">
                    <form action="update_riscos.php" method="POST" class="formulario">
                    <h2 class="text-center py-4">Alterar riscos</h2>
                        <input type="hidden" class="form-control" name="id" value="<?=$registro->id?>">
                        <div class="form-group">
                            <input type="text" class="form-control" name="categoria" placeholder="Digite a categoria do riscos" maxlength="40" pattern="[a-zA-Z0-9\ w]{0,40}" value="<?=$registro->categoria?>" required>
                        ...
                        <div class="form-group">
                            ...
                            <?php
                                ...
                                $lista = $objeto->selecionarSubcategoria();
                                foreach($lista as $subcategoria){
                                    if($subcategoria->id==$registro->id_subcategoria){
