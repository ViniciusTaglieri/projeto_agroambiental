        ...
        <div class="row">
            ...
            <div class="col-lg-10">
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <form action="inserir_medidas_controle.php" method="POST" class="needs-validation formulario" novalidate>
                            <h2 class="text-center py-4">Cadastro Medidas de controle</h2>
                            ...
                            <div class="form-group">
                                <textarea type="text" class="form-control" name="observacao" placeholder="Observação" required rows="3"></textarea>
                                <div class="valid-feedback"></div>
                                <div class="invalid-feedback"></div>
                            </div>
                            <div class="row">
