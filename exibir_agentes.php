<?php
  ...
  if(isset($_GET['id'])){
    $id = $_GET['id'];
    $objeto = new Agentes();
    $resultado = $objeto->apagarAgentes($id);
  }
?>
<!DOCTYPE html>
<html lang="pt-br">
        ...
        <div class="col-lg-8 table-responsive py-4">
            ...
            <table class="table table-hover table-bordered mt-5" style="background:white">
                <thead class="thead-dark">
                    <tr>
                        <th scope="col" style="vertical-align:middle">Agentes Ambientais</th>
                        <th scope="col" style="vertical-align:middle">Norma</th>
                        <th scope="col" style="vertical-align:middle">Metodologia</th>
                        <th scope="col" style="vertical-align:middle">Equipamento</th>
                ...
                <?php
                    ...
                    require_once("classes/agentes_ambientais.php");
                    $objeto = new Agentes();
                    $lista = $objeto->selecionarAgentes();
                ...
                ?>
                        <tr>
                            ...
                            if(!($acesso == "disabled")){
                            ?>
                                <td class="text-center"><a href='editar_agentes.php?id=<?=$registro->id?>'><i class='fas fa-edit'></i></a></td>
                                <td class="text-center"><a href='exibir_agentes.php?id=<?=$registro->id?>'><i class='fa fa-trash' aria-hidden='true'></i></a></i></td>
                            <?php
                            }
                            ?>
                        </tr>
