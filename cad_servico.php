    ...
    <div class="row">
        ...
        <div class="col-lg-10">
            <div class="row">
                ...
                <div class="col-lg-8">
                    <form action="inserir_servico.php" method="POST" class="needs-validation formulario" novalidate>
                        <h2 class="text-center py-4">Cadastro de Serviço</h2>
                        <div class="form-group">
                            <input type="text" class="form-control" name="nome" placeholder="Digite o nome do servico" maxlength="255" pattern="[a-zA-Z0-9\ w]{0,255}" required>
