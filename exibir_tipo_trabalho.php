...
if (isset($_GET['id'])) {
    ...
    $resultado = $objeto->apagarTipoTrabalho($id);
}
?>
<!DOCTYPE html>
<html lang="pt-br">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                if (!($acesso == "disabled")) {
                                ?>
                                    <td class="text-center"><a href='editar_tipo_trabalho.php?id=<?= $registro->id ?>'><i class='fas fa-edit'></i></a></td>
                                    <td class="text-center"><a href='exibir_tipo_trabalho.php?id=<?= $registro->id ?>'><i class='fa fa-trash' aria-hidden='true'></i></a></i></td>
                                <?php
                                }
                                ?>
                            </tr>
