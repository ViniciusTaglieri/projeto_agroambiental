<?php
    ...
    $id = $_GET['id'];
    $objeto = new servico();
    $resultado = $objeto->selecionarServicoWhere($id);
    ...
    <div class="row">
        ...
        <div class="col-lg-10">
            <div class="row">
                ...
                <div class="col-lg-8">
                    <form action="update_servico.php" method="POST" class="formulario">
                    <h2 class="text-center py-4">Alterar Serviço</h2>
                        <div class="form-group">
                            <input type="text" class="form-control" name="nome" placeholder="Digite o nome do serviço" maxlength="255" value="<?=$registro->nome?>" pattern="[a-zA-Z0-9\ w]{0,255}" required >
