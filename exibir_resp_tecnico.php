...
if (isset($_GET['id'])) {
    ...
    $resultado = $objeto->apagarRespTecnico($id);
}
?>
<!DOCTYPE html>
<html lang="pt-br">
                ...
                <table class="table table-hover table-bordered mt-5" style="background:white">
                    <thead class="thead-dark">
                        <tr>
                            ...
                            <th scope="col" style="vertical-align:middle">Crea</th>
                            <th scope="col" style="vertical-align:middle">Graduação</th>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                if (!($acesso == "disabled")) {
                                ?>
                                    <td class="text-center"><a href='editar_resp_tecnico.php?id=<?= $registro->id ?>'><i class='fas fa-edit'></i></a></td>
                                    <td class="text-center"><a href='exibir_resp_tecnico.php?id=<?= $registro->id ?>'><i class='fa fa-trash' aria-hidden='true'></i></a></i></td>
                                <?php
                                }
                                ?>
                            </tr>
