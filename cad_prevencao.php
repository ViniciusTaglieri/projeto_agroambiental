    ...
    <div class="row">
        ...
        <div class="col-lg-10">
            <div class="row">
                ...
                <div class="col-lg-8">
                    <form action="inserir_prevencao.php" method="POST" class="needs-validation formulario" novalidate>
                        <h2 class="text-center py-4">Cadastro de Fundamento Técnico Legal</h2>
                        <div class="form-group">
                            <textarea  type="text" class="form-control" name="texto" placeholder="Digite o nome do servico" maxlength="255" pattern="[a-zA-Z0-9\ w]{0,255}" required rows="3"></textarea>
