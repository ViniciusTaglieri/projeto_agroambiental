<?php
  ...
  if(isset($_GET['id'])){
    $id = $_GET['id'];
    $objeto = new local();
    $resultado = $objeto->apagarLocal($id);
  }
?>
<!DOCTYPE html>
<html lang="pt-br">
            ...
            <table class="table table-hover table-bordered mt-5" style="background:white">
                ...
                ?>
                        <tr>
                            ...
                            if(!($acesso == "disabled")){
                            ?>
                                <td class="text-center"><a href='editar_local.php?id=<?=$registro->id?>'><i class='fas fa-edit'></i></a></td>
                                <td class="text-center"><a href='exibir_local.php?id=<?=$registro->id?>'><i class='fa fa-trash' aria-hidden='true'></i></a></i></td>
                            <?php
                            }
                            ?>
                        </tr>
