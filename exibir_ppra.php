<?php
  ...
  if(isset($_GET['id'])){
    $id = $_GET['id'];
    $objeto = new ppra();
    $resultado = $objeto->apagarPpra($id);
  }
?>
<!DOCTYPE html>
<html lang="pt-br">
        ...
        <div class="col-lg-8 table-responsive py-4">
            ...
            <table class="table table-hover table-bordered mt-5" style="background:white">
                <thead class="thead-dark">
                    <tr>
                        <th scope="col" style="vertical-align:middle">Medidas de Controle</th>
                        <th scope="col" style="vertical-align:middle">Local</th>
                        <th scope="col" style="vertical-align:middle">Ghe</th>
                        <th scope="col" style="vertical-align:middle">Cbo</th>
                        <th scope="col" style="vertical-align:middle">Qt</th>
                        <th scope="col" style="vertical-align:middle">Descricao detalhada da função</th>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php
                                    ...
                                    $funcao = new local();
                                    $lista = $funcao->selecionarLocalWhere($registro->local);
                            ...
                            <td>
                                <?php
                                    ...
                                    $funcao = new funcao();
                                    $lista = $funcao->selecionarFuncaoWhere($registro->id_funcao);
                            ...
                            if(!($acesso == "disabled")){
                            ?>
                            <td class="text-center"><a href='editar_ppra.php?id=<?=$registro->id?>'><i class='fas fa-edit'></i></a></td>
                            <td class="text-center"><a href='exibir_ppra.php?id=<?=$registro->id?>'><i class='fa fa-trash' aria-hidden='true'></i></a></i></td>
                            <?php
                            }
                            ?>
                        </tr>
