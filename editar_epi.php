<?php
    ...
    $id = $_GET['id'];
    $objeto = new epi();
    $resultado = $objeto->selecionarEpiWhere($id);
    ...
    <div class="row">
        ...
        <div class="col-lg-10">
            <div class="row">
                ...
                <div class="col-lg-8">
                    <form action="update_epi.php" method="POST" class="formulario">
                    <h2 class="text-center py-4">Alterar Epi</h2>
                        <div class="form-group">
                            <input type="text" class="form-control" name="nome" placeholder="Digite o nome do epi" maxlength="60" value="<?=$registro->nome?>" pattern="[A-Za-z0-9\ w]{0,60}" required >
