                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <form action="inserir_ghe.php" method="POST" class="needs-validation formulario" novalidate>
                            ...
                            <div class="form-group">
                                <textarea class="form-control" name="desc_ambiente" required rows="3" placeholder="Digite a descrição do ambiente"></textarea>
                                <div class="valid-feedback"></div>
                                <div class="invalid-feedback">Deverá conter até 60 caracteres</div>
                            </div>
                            <div class="form-group">
