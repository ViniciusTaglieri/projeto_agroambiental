                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <form action="update_empresa_contratada.php" method="POST" class="formulario">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" name="razao_social" placeholder="Digite a razão social da empresa" maxlength="255" pattern="[A-Za-z0-9\ w]{0,60}" value="<?= $empresa->razao_social ?>">
                                <div class="valid-feedback"></div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="valid-feedback"></div>
                                <div class="invalid-feedback">Deverá conter 13 números</div>
                            </div>
                            <div class="form-group">
