<?php
  ...
  if(isset($_GET['id'])){
    $id = $_GET['id'];
    $objeto = new servico();
    $resultado = $objeto->apagarServico($id);
  }
?>
<!DOCTYPE html>
<html lang="pt-br">
        ...
        <div class="col-lg-8 table-responsive py-4">
            ...
            <table class="table table-hover table-bordered mt-5" style="background:white">
                ...
                <?php
                    ...
                    require_once("classes/servico.php");
                    $objeto = new servico();
                    $lista = $objeto->selecionarServico();
                ...
                ?>
                        <tr>
                            ...
                            if(!($acesso == "disabled")){
                            ?>
                            <td class="text-center"><a href='editar_servico.php?id=<?=$registro->id?>'><i class='fas fa-edit'></i></a></td>
                            <td class="text-center"><a href='exibir_servicos.php?id=<?=$registro->id?>'><i class='fa fa-trash' aria-hidden='true'></i></a></i></td>
                            <?php
                            }
                            ?>
                        </tr>
