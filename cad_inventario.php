            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <form action="inserir_inventario.php" method="POST" class="needs-validation formulario" novalidate>
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" name="agente" placeholder="Digite o agente" maxlength="60" pattern="[A-Za-z0-9\ w]{0,60}" required>
                            <div class="valid-feedback"></div>
                            <div class="invalid-feedback">Deverá conter até 60 caracteres</div>
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control" name="fonte_geradora" placeholder="Digite a fonte geradora" maxlength="60" pattern="[A-Za-z0-9\ w]{0,60}" required>
                            <div class="valid-feedback"></div>
                            <div class="invalid-feedback">Deverá conter até 60 caracteres</div>
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control" name="propagacao" placeholder="Digite a propagação do agente" maxlength="60" pattern="[A-Za-z0-9\ w]{0,60}" required>
                            <div class="valid-feedback"></div>
                            <div class="invalid-feedback">Deverá conter até 60 caracteres</div>
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control" name="danos_saude" placeholder="Digite os possíveis danos a saúde" maxlength="60" pattern="[A-Za-z0-9\ w]{0,60}" required>
                            <div class="valid-feedback"></div>
                            <div class="invalid-feedback">Deverá conter até 60 caracteres</div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" name="metodologia" placeholder="Digite a metodologia aplicada" maxlength="40" pattern="[A-Za-z0-9\ w]{0,40}" required>
                            <div class="valid-feedback"></div>
                            <div class="invalid-feedback">Deverá conter até 40 caracteres</div>
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control" name="intensidade" placeholder="Digite a intensidade da concentração" maxlength="60" pattern="[A-Za-z0-9\ w]{0,60}" required>
                            <div class="valid-feedback"></div>
                            <div class="invalid-feedback">Deverá conter até 60 caracteres</div>
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control" name="tolerancia" placeholder="Digite o limite de tolerância" maxlength="10" pattern="[A-Za-z0-9\ w]{0,10}" required>
                            <div class="valid-feedback"></div>
                            <div class="invalid-feedback">Deverá conter até 60 caracteres</div>
                        </div>
                        <div class="form-group">
