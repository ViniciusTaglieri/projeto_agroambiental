...
--
-- Host: 127.0.0.1
-- Tempo de geração: 29-Mar-2021 às 04:06
...
--
-- Extraindo dados da tabela `agentes_ambientais`
--

INSERT INTO `agentes_ambientais` (`id`, `agente`, `norma`, `metodologia`, `equipamento`) VALUES
(2, 'Vapores de Compostos Orgânicos', 'NR 15, A 11 e 12 American Conference of Governmental Industrial Hygienists - ACGIH / 2019', 'Método 1300, 1400, 1450, 1457, 1500, 1501 do Manual of Analytical Methods do National Institute for Occupational Safetyand Health - NIOSH', 'Coletor Gravimétrico em Baixa Vazão'),
(3, 'Aerodispersoides', 'NR 15, A 11 e 12 American Conference of Governmental Industrial Hygienists - ACGIH / 2019', 'Método 0600 do Manual of Analytical Methods do National Institute for Occupational Safetyand Health - NIOSH', 'Coletores Gravimétricos'),
(4, 'Ruído', 'NR 15, A 1 e 2', 'NHO-1 da FUNDACENTRO', 'Dosímetro de Ruído');
...
INSERT INTO `anexo` (`id`, `nome`, `id_ghe`, `id_funcao`) VALUES
(6, 'Vinicius', 20, 7);
...
INSERT INTO `cad_empresas` (`cnpj`, `razao_social`, `fantasia`, `insc_estadual`, `insc_municip`, `endereco`, `distrito`, `secao`, `grupo`, `economica`, `numero`, `bairro`, `id_cidade`, `uf`, `cep`, `telefone`, `email`, `cnae`, `id_grau_risco`, `trab_admin`, `trab_operac`, `carga_horaria_admin`, `carga_horaria_operac`) VALUES
(11111111111111, '', '', '', 0, '', '', '', '', '', 0, '', 8534, 26, 0, 0, 'loirovinicius360@gmail.com', 0, 7, 0, 0, NULL, NULL),
(12349090901111, 'razao social', 'fantasia', '1234', 312, 'rua dos endereco', '', '', '', '', 9090, 'Bairro', 8534, 26, 13660000, 5519971231865, 'vinicius@email.com', 112199, 7, 1, 1, 9, 9);
...
INSERT INTO `carga_horaria` (`id`, `horas`, `entrada1`, `saida1`, `entrada2`, `saida2`, `id_tipo_trabalho`, `jornada`) VALUES
(9, 44, '08h00', '12h00', '13h20', '18h00', 1, 'Segundas-feiras às sextas-feiras: das 08h00’ às 12h00’ e das 13h00’ às 18h00’'),
(10, 44, '08h00', '12h00', '13h20', '18h00', 2, 'Segundas-feiras às sextas-feiras: das 08h00 às 12h00 e das 13h00 às 18h00'),
(11, 44, '08h00', '12h00', '13h20', '18h00', 2, 'SEGUNDAS-FEIRAS ÀS SEXTAS-FEIRAS');
...
--
-- Extraindo dados da tabela `categ_risco_indicea`
--

INSERT INTO `categ_risco_indicea` (`id`, `condicao`, `descricao`, `pontos`, `recomendacao`) VALUES
(7, 'Condição', 'Descrição', 1, 'Recomendação');
...
INSERT INTO `cbo` (`id`, `nome`) VALUES
...
INSERT INTO `cnae` (`id_cnae`, `codigo_cnae`, `desc_cnae`) VALUES
...
INSERT INTO `email` (`id`, `emailEnvia`, `senhaEnvia`, `emailRecebe`, `nomeRecebe`, `smtp`, `portaSmtp`) VALUES
(1, 'viniciuslol.vm@gmail.com', 'qsefrdwa123', 'viniciuslol.vm@gmail.com', 'Vinicius Marangoni', 'smtp.gmail.com', '587');
...
--
-- Extraindo dados da tabela `empresa_contratada`
--

INSERT INTO `empresa_contratada` (`id`, `razao_social`, `cnpj`, `fantasia`, `endereco`, `complemento`, `bairro`, `municipio`, `uf`, `cep`, `telefone`, `email`) VALUES
(0, 'JOYCE CRISTINA TESSARIN CONSULTORIA', '27774697000', 'Agroambiental', 'Rua Cel. Arthur Whitacker, 382', 'Edifício Di Napoli, Sala 1, Térreo', 'Centro', 8534, 26, 13690000, '1935838318', 'CONTATO@AGROAMBIENTALCONSULTORIA.COM');
...
INSERT INTO `funcao` (`id`, `nome`, `descricao`, `id_cbo`, `id_epi`) VALUES
(7, 'Alterar função', 'Lorem Ipsum é simplesmente um texto fictício da indústria de impressão e composição. Lorem ', 0, ''),
(9, 'funcaos', 'Lorem Ipsum é simplesmente um texto fictício da indústria de impressão e composição. Lorem Ipsum tem sido o texto fictício padrão da indústria desde os anos 1500, quando um impressor desconhecido pegou uma galé do tipo e embaralhou para fazer um livro de amostra de tipos. Ele sobreviveu não apenas cinco séculos, mas também ao salto para a composição eletrônica, permanecendo essencialmente inalterado. Ele foi popularizado na década de 1960 com o lançamento de folhas de Letraset contendo passagens de Lorem Ipsum e, mais recentemente, com software de editoração eletrônica como Aldus PageMaker incluindo versões de Lorem Ipsum.', 0, 'Capacete, Oculos');
...
--
-- Extraindo dados da tabela `funcao_ghe`
--

INSERT INTO `funcao_ghe` (`id`, `id_ghe`, `id_funcao`, `qt`, `resp_cargo`) VALUES
(1, 11, 7, '1', 'RESP'),
(2, 12, 7, '1', 'resp'),
(3, 13, 7, '1', 'resp'),
(4, 13, 9, '2', 'resp'),
(5, 14, 7, '1', 'resp'),
(6, 14, 9, '4', 'responsabilidade'),
(7, 15, 7, '1', 'resp'),
(8, 16, 9, '1', 'resp'),
(9, 16, 7, '1', 'resp cargo'),
(10, 16, 9, '2', 'reesp cargo'),
(11, 16, 7, '1', 'res'),
(12, 17, 7, '1', 'res'),
(13, 18, 7, '1', 'resp'),
(14, 18, 9, '1', 'resp carg'),
...
--
-- Extraindo dados da tabela `ghe`
--

INSERT INTO `ghe` (`id`, `id_empresa`, `nome`, `setor`, `local`, `carga_horaria`, `desc_ambiente`) VALUES
(20, 12349090901111, 'AGRO 01', 2, 2, 10, 'desc'),
(21, 12349090901111, 'AGRO 02', 3, 3, 10, 'Descricao');
...
CREATE TABLE `inventario_riscos` (
  ...
  `propagacao` varchar(60) NOT NULL,
  `danos_saude` varchar(60) NOT NULL,
  `avaliacao` varchar(60) NOT NULL,
  `metodologia` varchar(40) NOT NULL,
  `intensidade` varchar(60) NOT NULL,
...
--
-- Extraindo dados da tabela `inventario_riscos`
--

INSERT INTO `inventario_riscos` (`id`, `id_ghe`, `natureza`, `agente`, `fonte_geradora`, `propagacao`, `danos_saude`, `avaliacao`, `metodologia`, `intensidade`, `tolerancia`, `anexo`, `risco`, `protecao`, `tempo`, `grau_risco`, `codigo`) VALUES
(4, 20, 'Físico', 'Radiação Não-Ionizante', 'Radiação Solar (raios ultravioletas UV)', 'Cutânea (Pele)', 'Insolação; Irritação nos olhos; Fotoenvelhecimento', 'Qualitativa / Intermitente', 'NR 15, A 7', '-', '-', '-', '2', '1', '2', '5', '01.01.002'),
(5, 20, 'Físico', 'Ruído contínuo ou intermitente', 'Vozes Humanas', 'Ondas Sonoras', 'Estresse; Falta de Concentração', 'Quantitativa / Intermitente', 'NHO 01 NR 15, A 1 e 2', 'TWA 55,5 dB NEN 51,8 dB', '85 dB', 'IV', '1', '1', '2', '1 - Baixo', '01.01.002'),
(6, 20, 'Químico', 'Detergentes Automotivos', 'Lavagem de veículos e máquinas', 'Vias Aéreas; Cutânea (pele)', 'Doenças da Pele; Doenças Respiratórias', 'Quantitativa / Intermitente', 'Inspeção in loco', '-', '-', '-', '1', '2', '2', '1 - Baixo', '02.01.999'),
(7, 20, 'Biológico', 'Xileno', 'Fonte', 'Ar', 'olho', 'quantitiativa', 'NR 17', '12', '45 dB', 'II', '1', '1', '2', 'baixo', '02.01.780'),
(8, 20, 'Biológico', 'Xileno', 'Ambiente Laboral', 'Sistema Respiratório; Contato com a Pele', 'Irritação dos Olhos; da Pele; Sinais de Intoxicação por Inal', 'Quantitativa / Intermitente', 'NIOSH / NR 15, A 11 e 12 / ACGiH', '4,7 (ppm)', '78 (ppm', 'II', '1', '1', '2', '1 - Baixo', '02.01.780'),
(9, 20, 'Ergonômico', 'Postura em pé por longos períodos', 'Exigência Postural', 'Estrutura Osteomuscular', 'Desconforto Osteomuscular', 'Quantitativa / Intermitente', 'NR 17', '-', '-', '-', '1', '1', '2', '1 – Baixo', '04.01.003'),
(10, 20, 'Mecânicos/Acidentes', 'Batidas contra', 'Durante atividades de rotina', 'Contato com o corpo', 'Lesões; Escoriações; Entorses', 'Quantitativa / Intermitente', '-', '-', '-', '-', '1', '1', '1', '1 - Baixo', '05.01.999');
...
--
-- Extraindo dados da tabela `medidas_controle`
--

INSERT INTO `medidas_controle` (`id`, `id_ghe`, `trabalhador`, `empregador`, `ergonomico`, `epc`, `epi`, `parecer_tecnico`, `insalubridade`, `periculosidade`, `observacao`) VALUES
(1, 20, '- Utilizar, de forma adequada, todos os EPI de uso obrigatório.\r\n- Manter atenção e vigilância constantes ao adentrar no ambiente laboral, em especial, durante a realização das atividades.\r\n- Manter as vias de circulação e os espaços, em geral, organizados, limpos e livres de obstáculos.\r\n- Respeitar as sinalizações de segurança.\r\n- Não permitir e nem realizar improvisos nos postos de trabalho.\r\n- Não operar e/ou ligar qualquer equipamento inadvertidamente.\r\n- Realizar exames médicos conforme preconizados no PCMSO.', '- Priorizar as medidas de proteção coletiva e mantê-las.\r\n- Fornecer, exigir e fiscalizar a utilização de EPI com Certificado de Aprovação (C.A.).\r\n- Prover a realização dos treinamentos recomendados.', '- Manter a postura correta sempre (coluna vertebral sempre alinhada).\r\n- Realizar pausas de 10 minutos durante a jornada diária de trabalho: uma no período manhã e outra no período da tarde.', 'Rede de Hidrante / Extintores de Incêndio / Placas de Sinalização de Segurança / Faixas de Sinalização de Segurança', '- Botina de Segurança - Creme Protetor de Segurança - Tipo luva química para pele - Grupo 3 - Luva de Proteção contra Agentes Mecânicos - Luva Nitrílica para Proteção contra Agentes Químicos - Óculos de Segurança Incolor - Protetor Auricular Tipo Concha - Respirador Purificador de Ar Tipo Peça Semifacial com Filtro Químico (para químicos classe 1)', 'De acordo com o Art. 191 da CLT – Consolidação das Leis do Trabalho:\r\nA eliminação ou a neutralização da insalubridade ocorrerá:\r\nI - Com a adoção de medidas que conservem o ambiente de trabalho dentro dos limites de tolerância;\r\nII - Com a utilização de equipamentos de proteção individual ao trabalhador, que diminuam a intensidade do agente agressivo a limites de tolerância', 0, 0, 'A caracterização descrita acima - neste Parecer - é válida somente, enquanto as condições de trabalho permanecerem com aquelas observadas e informadas durante os levantamento in loco.');
...
--
-- Extraindo dados da tabela `meio_ambiental`
--

INSERT INTO `meio_ambiental` (`id`, `documento`, `empresa`, `emissao`, `vencimento`, `lembrete`) VALUES
(10, 3, 11111111111111, '2020-10-17', '2020-10-17', '2020-10-17');
...
--
-- Extraindo dados da tabela `ppra`
--

INSERT INTO `ppra` (`id`, `controle`, `local`, `ghe`, `cbo`, `qt`, `id_funcao`) VALUES
(2, 'Controle', '2', '123', 10310, 2, 7);
...
--
-- Extraindo dados da tabela `prevencao`
--

INSERT INTO `prevencao` (`id`, `texto`) VALUES
(1, 'Redação dada pela Portaria 25, de 29 de dezembro de 1994 do Ministério do Trabalho e Emprego - MTE.'),
(2, 'Constante da Norma Regulamentadora 09 - NR 09; da Portaria Nº 3.214, de 08 de junho de 1978.');
...
--
-- Extraindo dados da tabela `resp_tecnico`
--

INSERT INTO `resp_tecnico` (`id`, `nome`, `crea`, `func`) VALUES
(3, 'JOYCE CRISTINA TESSARIN', '5062958584', 'Engenheira de Segurança do Trabalho / Engenheira Ambiental');
...
(5, 'Outorga '),
(6, 'Dispensa de outorga'),
(7, 'Relatório de monitoramento de plantio '),
(8, 'Laudo técnico ambiental'),
(11, 'Ergonômico');
...
INSERT INTO `tipo_trabalho` (`id`, `tipo`) VALUES
(1, 'Operacional'),
(2, 'Administrativo');
...
--
ALTER TABLE `cnae`
  MODIFY `id_cnae` int(16) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1303;
