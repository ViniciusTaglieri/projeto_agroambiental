        ...
        <div class="row">
            ...
            <div class="col-lg-10">
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <form action="inserir_ppra.php" method="POST" class="needs-validation formulario" novalidate>
                            <h2 class="text-center py-4">Cadastro de Detalhe da Função</h2>
                            <div class="form-group">
                                <input type="text" class="form-control" name="controle" placeholder="Digite o setor" maxlength="140" pattern="[A-Za-z0-9\ w]{0,140}" required>
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" name="ghe" placeholder="Digite número do ghe" maxlength="60" pattern="[A-Za-z0-9\ w]{0,6}" required>
                                <div class="valid-feedback"></div>
                                <div class="invalid-feedback">Deverá conter até 6 caracteres</div>
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" name="cbo" placeholder="Digite número do cbo" maxlength="60" list="cbo" pattern="[A-Za-z0-9\ w]{0,6}" required>
                                <datalist id="cbo">
                                    <?php
                            ...
                            <div class="form-group">
                                <input type="number" class="form-control" name="qt" placeholder="Digite o número do qt" maxlength="2" pattern="[A-Za-z0-9\ w]{0,2}" required>
                                <div class="valid-feedback"></div>
