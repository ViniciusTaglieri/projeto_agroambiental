    ...
    <div class="row">
        ...
        <div class="col-lg-10">
            <div class="row">
                ...
                <div class="col-lg-8">
                    <form action="inserir_meio_ambiental.php" method="POST" class="needs-validation formulario" novalidate>
                        <h2 class="text-center py-4">Cadastro Documento ambiental</h2>
                        <div class="form-group">
                            <input type="text" class="form-control" name="empresa" placeholder="Digite o cnpj da emresa" maxlength="14" list="empresa" pattern="[0-9]{0,14}" required>
                            <datalist id="empresa">
                            <?php
                                $objeto = new empresa();
                                $lista = $objeto->selecionarEmpresa();
                                foreach($lista as $empresa){
                                    echo '<option value="'.$empresa->cnpj.'"></option>';
                                }
                            ?>
                            </datalist>
                        ...
                        <div class="form-group">
                            <select name="documento" class="form-control" required>
                                ...
                                <?php
                                    ...
                                    $lista = $objeto->selecionarDocumento();
                        ...
                        <div class="form-group">
                            <?php $hoje = date('Y-m-d'); ?>
                            <input type="date" class="form-control" name="emissao" required value="<?=$hoje?>">
                        </div>
                        <div class="form-group">
                            <input type="date" class="form-control" name="vencimento" required>
                        </div>
                        <div class="form-group">
                            <input type="date" class="form-control" name="lembrete" disabled>
                        </div>
                        <div class="row">
                            <div class="col-lg-4">
